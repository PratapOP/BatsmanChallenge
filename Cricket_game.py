...
def play_game():
    ...
    while True:
        ...
        if shot_choice == "1":
            outcome = random.choices(["0", "1", "2", "4", "OUT"], weights=[35, 22, 14, 10, 9])[0]
        elif shot_choice == "2":
            outcome = random.choices(["0", "1", "2", "4", "OUT"], weights=[25, 30, 25, 10, 10])[0]
        elif shot_choice == "3":
            outcome = random.choices(["0", "1", "2", "4", "6", "OUT"], weights=[10, 15, 20, 20, 15, 20])[0]
        elif shot_choice == "4":
            outcome = random.choices(["0", "1", "2", "4", "6", "OUT"], weights=[10, 15, 10, 20, 20, 25])[0]
        else:
